    ...
    return CustomBackground(header: "Cadastro do motorista", children: [
      ...
      Align(
        ...
        child: Text(
          "Suas informações",
          textScaleFactor: 1,
          style: TextStyle(color: Color.fromARGB(255, 137, 202, 204), fontSize: MediaQuery.of(context).size.width * 0.073, fontWeight: FontWeight.bold),
        ),
      ),
      SizedBox(
        height: 40,
      ...
      CustomTextField(
        formatter: new MaskTextInputFormatter(
            mask: "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
      ...
      Observer(builder: (_) {
        return CustomPassTextField(
          ...
          suffix: CustomIconButton(
            radius: 32,
            iconData: cadastro2Store.passVisible ? Icons.visibility : Icons.visibility_off,
        ...
        builder: (_) {
          return SizedBox(
            ...
            child: RaisedButton(
              ...
              color: cadastro2Store.isFormValid ? Color.fromARGB(255, 25, 153, 158) : Color.fromARGB(255, 210, 210, 210),
              textColor: Colors.white,
              onPressed: () {
                cadastro2Store.isFormValid
                    ? Navigator.of(context).push(MaterialPageRoute(builder: (context) => Cadastro3()))
