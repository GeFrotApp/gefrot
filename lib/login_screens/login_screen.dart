...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    return CustomBackground(header: "Acesse sua conta", children: [
      SizedBox(
        height: 30,
      ),
      Align(
      ...
      SizedBox(
        ...
        child: RaisedButton(
          ...
          child: Text('CADASTRAR-SE', style: TextStyle(fontSize: MediaQuery.of(context).size.width*0.056, color: Color.fromARGB(255, 25, 153, 158))),
