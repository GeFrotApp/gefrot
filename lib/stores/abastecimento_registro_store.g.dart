...
mixin _$AbastecimentoRegistroStore on _AbastecimentoRegistroStore, Store {
  ...
  bool get isFormValid =>
      (_$isFormValidComputed ??= Computed<bool>(() => super.isFormValid, name: '_AbastecimentoRegistroStore.isFormValid')).value;
  ...
  void setData(dynamic value) {
    final _$actionInfo = _$_AbastecimentoRegistroStoreActionController.startAction(name: '_AbastecimentoRegistroStore.setData');
    try {
  ...
  void setOdometro(dynamic value) {
    final _$actionInfo =
        _$_AbastecimentoRegistroStoreActionController.startAction(name: '_AbastecimentoRegistroStore.setOdometro');
    try {
  ...
  void setTanqueCheio(dynamic value) {
    final _$actionInfo =
        _$_AbastecimentoRegistroStoreActionController.startAction(name: '_AbastecimentoRegistroStore.setTanqueCheio');
    try {
