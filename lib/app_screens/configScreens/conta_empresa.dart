                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(baseStore.nomeEmpresa,
                                textScaleFactor: 1,
                                style: TextStyle(color: Color.fromARGB(250, 120, 120, 120), fontSize: MediaQuery.of(context).size.width * 0.030))
                          ],
                        ),
                      ),
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                                baseStore.cnpj.substring(0, 2) +
                                    ". " +
                                    baseStore.cnpj.substring(2, 5) +
                                    ". " +
                                    baseStore.cnpj.substring(5, 8) +
                                    "/" +
                                    baseStore.cnpj.substring(8, 12) +
                                    "-" +
                                    baseStore.cnpj.substring(12, 14),
                                textScaleFactor: 1,
                                style: TextStyle(color: Color.fromARGB(250, 120, 120, 120), fontSize: MediaQuery.of(context).size.width * 0.030))
                          ],
                        ),
